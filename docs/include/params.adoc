IMPORTANT: 2020-02-29 06:44:22[[availability-zone-configuration]]
...
|=======================================================================
[[caution-deprecated-nat-instance-configuration]]
CAUTION: DEPRECATED: NAT Instance Configuration
-----------------------------------------------

[width="100%",cols="47%,7%,46%",options="header",]
|=======================================================================
|Parameter label (name) |Default |Description
|**CAUTION: DEPRECATED: Key pair name**(`KeyPairName`) |deprecated
|CAUTION: DEPRECATED. NAT gateways are now supported in all regions.

|**CAUTION: DEPRECATED: NAT instance type**(`NATInstanceType`)
|deprecated |CAUTION: DEPRECATED. NAT gateways are now supported in all
regions.
|=======================================================================
