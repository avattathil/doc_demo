...
|=======================================================================
[[old_not_used-nat-instance-configuration]]
OLD_NOT_USED: NAT Instance Configuration
----------------------------------------
...
|=======================================================================
|Parameter label (name) |Default |Description
|**OLD_NOT_USED: Key pair name**(`KeyPairName`) |deprecated
|OLD_NOT_USED. NAT gateways are now supported in all regions.

|**OLD_NOT_USED: NAT instance type**(`NATInstanceType`) |deprecated
|OLD_NOT_USED. NAT gateways are now supported in all regions.
|=======================================================================
