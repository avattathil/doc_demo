IMPORTANT: Updated on 2020-02-29 09:34:28

[[availability-zone-configuration]] Availability Zone Configuration
-------------------------------

[width="100%",cols="27%,11%,62%",options="header",]
|=======================================================================
|Parameter label (name) |Default |Description |**Availability
Zones**(`AvailabilityZones`) |**Requires Input** |List of Availability
Zones to use for the subnets in the VPC. Note: The logical order is
preserved.
...
|=======================================================================
|Parameter label (name) |Default |Description |**VPC CIDR**(`VPCCIDR`)
...
|=======================================================================
[[deprecated-nat-instance-configuration]] DEPRECATED: NAT Instance
Configuration --------------------------------------

[width="100%",cols="46%,8%,46%",options="header",]
|=======================================================================
|Parameter label (name) |Default |Description |**DEPRECATED: Key pair
name**(`KeyPairName`) |deprecated |DEPRECATED. NAT gateways are now
